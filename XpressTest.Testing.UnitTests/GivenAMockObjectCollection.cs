...
public class GivenAMockObjectCollection
{
    ...
    public void WhenItGetsAMockAndNoMocksHaveBeenRegisteredThenItThrowsMockNotRegisteredException()
    {
        ...
        exception.Should().BeOfType<MockNotRegisteredException>();
        exception.Message.Should().Be("No mock of type Object registered");
    }
    ...
    public void WhenItGetsANamedMockAndNoNamedMocksHaveBeenRegisteredThenItThrowsNamedMockNotRegisteredException()
    {
        ...
        exception.Should().BeOfType<NamedMockNotRegisteredException>();
        exception.Message.Should().Be("No mock of type Object with name Name registered");
    }
    ...
    public void WhenItGetsANamedMockAndAMockOfADifferentTypeWithTheNameHasBeenRegisteredThenItThrowsNamedMockDifferentTypeRegisteredException()
    {
        ...
        exception.Should().BeOfType<NamedMockDifferentTypeRegisteredException>();
        exception.Message.Should().Be("Expected mock with name Name is not of type Object");
    }
}