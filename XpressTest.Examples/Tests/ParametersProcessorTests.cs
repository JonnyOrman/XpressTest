...
public class ParametersProcessorTests
{
    ...
    public void ProcessValidParameters() =>
        GivenA<ParametersProcessor>
            ...
            .Then<IValidator>()
                .Should<bool>(arrangement => validator => validator.IsValid(arrangement.GetObject<EntityParameters>()))
                .Once()
            .Then<ICreator>()
                .Should<Entity>(arrangement => creator => creator.Create(arrangement.GetObject<EntityParameters>()))
                .Once()
